...
def prepare_defect_dataset_fin(filename, path_data):
    ...
    numerical_vars = ['CountDeclMethodPrivate', 'AvgLineCode', 'CountLine', 'MaxCyclomatic', 'CountDeclMethodDefault',
                      ...
                      'CountLineComment', 'CountDeclClass',
                      ...
                      'SumCyclomatic', 'SumEssential', 'CountStmtDecl', 'CountLineCode', 'CountStmtExe',
                      'RatioCommentToCode',
                      ...
                      'CountPath_Mean',
                      'CountPath_Min', 'MaxNesting_Max', 'MaxNesting_Mean', 'MaxNesting_Min', 'COMM', 'ADEV', 'DDEV',
                      'Added_lines',
                      'Del_lines', 'OWN_LINE', 'OWN_COMMIT', 'MINOR_COMMIT', 'MINOR_LINE', 'MAJOR_COMMIT', 'MAJOR_LINE']
    categorical_vars = []

    # path_data='/home/<name>/defects/jira_n/'+file
    # file_name = file
